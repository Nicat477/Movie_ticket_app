                  ...
                  child: Row(
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 10),
                        Icon(Icons.favorite_outline,size:25,color:Colors.white)
                      ],
                    )
                  ]),
                  ),
          ...
          Padding(
            ...
            child: Column(
                    ...
                    itemBuilder: (context,index){
                      return InkWell(
                        child: Container(
                          ...
                          padding: EdgeInsets.symmetric(horizontal: 10),
                          decoration: BoxDecoration(
                            color:index==1 ? Color(0xFFF7D300) : Color(0xFF212429),
                            borderRadius: BorderRadius.circular(5),
                            border: index!=1 ? Border.all(color:Colors.white) : null
                          ),
                          child: Center(
                            child: Text(formats[index],style: TextStyle(
              ...
              Row(children: [
                    ...
                    Text("City Complex Cinema",style: TextStyle(color:Colors.white70,fontWeight: FontWeight.w600),),
                    Spacer(),
                    ...
                    itemBuilder: (context,index){
                      return InkWell(
                        child: Container(
                          ...
                          child: Center(
                            child: Text("${index+8} :30 AM",style: TextStyle(
                              fontSize: 17,
                    ...
                    itemBuilder: (context,index){
                      return InkWell(
                        child: Container(
                          ...
                          child: Center(
                            child: Text("${index+11} :30 AM",style: TextStyle(
                              fontSize: 17,
